...
const config = require("./team.datasource.json");
let TeamDataSource = class TeamDataSource extends repository_1.juggler.DataSource {
...
TeamDataSource.dataSourceName = 'Team';
TeamDataSource = __decorate([
    __param(0, core_1.inject('datasources.config.Team', { optional: true })),
    __metadata("design:paramtypes", [Object])
], TeamDataSource);
exports.TeamDataSource = TeamDataSource;
//# sourceMappingURL=team.datasource.js.map